		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					pass2 = b['first_name'] + b['Birth_Year']
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							pass3 = b['first_name'] + b['mobile_phone']
